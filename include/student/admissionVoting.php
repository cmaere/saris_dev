...
$post = mysql_query($query_post, $cha) or die(mysql_error());
...
if ($name==0){
	...
	exit;
		...
		$dbins = mysql_query($qins) or die('Rejected, cha Knows that you are attempting to vote once more!');
...
<fieldset>
	<legend>Step 2: Select Candidate</legend>
		<form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="frmAyear" target="_self">
