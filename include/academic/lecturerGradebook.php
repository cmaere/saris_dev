		...
		<div id="content" "="">
	<h2>Grade Book Page <span>for Student Academic Record Information System (SARIS)</span></h2>

<div class="innerLR">
	<!-- Intro message -->
	<div class="widget" data-toggle="collapse-widget">
		<div class="widget-head">
			<h4 class="heading glyphicons cardio">Grade Book Form</h4>
		</div>
...
$userdept = mysql_query($query_userdept, $cha) or die(mysql_error());
...
$userfac = mysql_query($query_userfac, $cha) or die(mysql_error());
...
$dept = mysql_query($query_dept, $cha) or die(mysql_error());
...
// Process of exam grade form entry intro
    ...
    $examcategory = mysql_query($query_examcategory, $cha) or die(mysql_error());
    ...
    $coursecode = mysql_query($query_coursecode, $cha) or die(mysql_error());

    ?>
     <fieldset>
        <legend>Select Appropriate Entries</legend>
            <form action="/?page=GradeBookAdd&section=Examination" method="post" enctype="multipart/form-data" name="frmCourse" target="_self">
            <table width="200" border="1" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <!-- A Separate Layer for the Calendar -->
                        <script language="JavaScript" src="cha_files/datepicker/Calendar1-901.js" type="text/javascript"></script>
                         <table border="0">
                                        <tr>
                                        <?php
