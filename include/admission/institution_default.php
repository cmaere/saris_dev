		...
		<table class="table table-striped b-t text-sm"> 
			<thead> 
				<tr> 
					...
					<th data-toggle="class" class="th-sortable">Campus 
						<span class="th-sort">
			...
			<tbody> 
				<tr> 
					...
					<td>$email</td>     
					<td> 
					<a  class='active' href='./?page=Institution&section=Policy&edit=$id'>
		...
		<div class="row"> 
			<div class="col-sm-4 hidden-xs">
				 <select class="input-sm form-control input-s-sm inline"> 
				 	...
				 	<option value="1" onClick=" delete_records('<?php echo $editFormAction; ?>');">Delete selected</option> 
		 	...
		 	<div class="col-sm-4 text-right text-center-xs"> 
				 <ul class="pagination pagination-sm m-t-none m-b-none"> 
					...
					else
					{
						...
						echo"<li><a href='./?page=Institution&section=Policy&pageNum_inst=$maxpage$queryString_inst'><i class='fa fa-chevron-left'></i></a></li>";
				        ...
				        if($pageNum_inst <> 0)
				        {
				       	 	for($i=1; $i<=$pageNum_inst; $i++)
				       	 	{
				       	 	       ...
				       	 	       echo "<li><a href='"; 							  printf("./?page=Institution&section=Policy&pageNum_inst=%d%s", min($totalPages_inst, $i - 1), $queryString_inst);
						       echo"'>$i</a></li>";
				       	 //$lastpage = $lastpage + 1;
				       	        }
					...
					{
						?> 
						<li><a href="<?php printf("./?page=Institution&section=Policy&pageNum_inst=%d%s",min($totalPages_inst, $pageNum_inst + 1), $queryString_inst); ?>"><i class="fa fa-chevron-right"></i></a></li>
						<?php 
